...
class MyTestCase(unittest.TestCase):
    ...
    def test_str_method(self):
        test_milk = milk.Milk(1000, "Plain Milk inc.", datetime.strptime("2017-01-01", "%Y-%m-%d"), 2.8, 210)
        self.assertEqual("Milk{cubicCapacity: 1000 ml, producer: 'Plain Milk inc., bestBefore: 2017-01-01 00:00:00, fatContent: 2.8, price: 210 forint(s)}", test_milk.__str__())
