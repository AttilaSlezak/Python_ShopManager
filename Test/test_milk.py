...
class MyTestCase(unittest.TestCase):
    ...
    def setUp(self):
        self.test_milk = Milk(101, Milk.LITER, "Plain Milk inc.", MyTestCase.test_date, Milk.WHOLE_MILK, 210)
    ...
    def test_incorrect_data_to_initialize_milk(self):
        with self.assertRaises(ValueError):
            Milk(101, Milk.LITER, "Plain Milk inc.", MyTestCase.test_date, 28, 210)
    ...
    def test_str_method(self):
        self.assertEqual("Milk{barcode: 101, cubic capacity: 1000 ml, producer: 'Plain Milk inc.', best before: " +
            str(MyTestCase.test_date) + ", fat content: 2.8, price: 210 forint(s)}", self.test_milk.__str__())
